standardsccs2 <- function(formula, indiv, astart, aend, aevent, adrug, aedrug, expogrp = list(), washout = list(), 
  ...
  # this doesn't work well when manually changing reference levels as the level is picked up as a covariate
  # a simple workaround for this project is therefore setting this straight to zero
